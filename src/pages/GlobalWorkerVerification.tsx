...
const GlobalWorkerVerification = () => {
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Global Worker Verification — Verify Remote Hires Once"
        description="How global worker verification works: confirm identity, documents and work eligibility for remote hires in minutes, then reuse that verification with every employer."
        path="/global-worker-verification"
        type="article"
        breadcrumbs={[{ name: "Global Worker Verification", path: "/global-worker-verification" }]}
      />
      {/* Navigation */}
